...
class Students extends AbstractStudents{
    ...
    //DITUGASKAN
    static function selectById($id) { // select data berdasarkan id
        global $conn;
    ...
    //DITUGASKAN
    static function selectWhere($clause) { // select data berdasarkan kondisi
        global $conn;
    ...
    //DITUGASKAN
    static function updateWhere($clause, $name, $email, $role_fk) { // select data berdasarkan kondisi
        global $conn;
    ...
    //DITUGASKAN
    static function deleteById($id) { // delete data berdasarkan id
        global $conn;
    ...
    //DITUGASKAN
    static function deleteWhere($clause) { // detele data berdasarkan kondisi
        global $conn; 
